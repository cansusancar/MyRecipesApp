...
@AndroidEntryPoint
class TatlilarFragment : Fragment() {
    private val sharedViewModel: SharedViewModel by activityViewModels()
    private lateinit var favoriteRecyclerView: RecyclerView
    private lateinit var binding: FragmentTatlilarBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val rootView = inflater.inflate(R.layout.fragment_tatlilar, container, false)
        ...
        binding = FragmentTatlilarBinding.inflate(inflater, container, false)
        ...
        val sharedPreferences =
            requireActivity().getSharedPreferences("My AppPreferences", Context.MODE_PRIVATE)
        val gson = Gson()

        val selectedRecipesJson = sharedPreferences.getString("seciliTarifler", null)
        ...
        val adapter = TatlilarAdapter(requireContext(),
            selectedRecipes0,
